...
pif_LongInt/UnsignedDouble
	...
	// FIXED_PRECISION and UNSIGNED_MODE are fixed operation modes that should not
	// be changed. If this library is used correctly (e.g., using only the public
	// methods and not using private members or directly accessing variables) then
	// the fixed flags can't be changed.
